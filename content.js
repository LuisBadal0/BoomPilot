if (globalThis.__boompilotInjected) {
  // Already injected in this frame (manifest content_scripts + scripting.executeScript)
  // Guard prevents duplicate MutationObserver and runtime.onMessage listeners.
} else {
  globalThis.__boompilotInjected = true;
